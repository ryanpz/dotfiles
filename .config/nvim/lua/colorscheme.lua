...
local set_groups = function(p)
  local groups = {
    ...
    IncSearch = { fg = p.black, bg = p.inc_search_bg },
    ...
    diffFile = { fg = p.nontext },
    diffLine = { link = 'Keyword' },
    diffIndexLine = { link = 'Keyword' },
    ...
    htmlArg = { fg = p.green },
    htmlBold = { fg = p.yellow, bold = true },
    ...
    htmlH5 = { fg = p.pink },
    htmlH6 = { fg = p.pink },
    htmlItalic = { fg = p.purple, italic = true },
    htmlLink = { fg = p.purple, underline = true },
    htmlSpecialChar = { fg = p.yellow },
    htmlSpecialTagName = { fg = p.cyan },
    htmlTag = { fg = p.fg },
    htmlTagN = { fg = p.pink },
    htmlTagName = { fg = p.pink },
    htmlTitle = { fg = p.fg },
    ['@variable'] = { fg = p.fg },
